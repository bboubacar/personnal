            ...
            <div className="bcr-about-introduce">
                ...
                <div className="bcr-about-details">
                    ...
                    <p>
                        ...
                        d'un stage aux périodes:{" "}
                        <strong>
                            15 Avril 2024 au Lundi 06 Mai 2024, 17 Juin 2024 au
                            12 Juillet 2024, 26 Aout 2024 au 13 Septembre 2024
                        </strong>
                    </p>
                    <div className="adresse">
                        ...
                        <p>(+33) 744 17 51 19</p>
                        <p>
                            <a href={`#${constactId}`}>bboubacarfr@gmail.com</a>
                        </p>
                    </div>
                </div>
            </div>
